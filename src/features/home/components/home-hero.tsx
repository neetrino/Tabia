  ...
  return (
    <section className="relative -mt-28 bg-[#fefefe] lg:-mt-24">
      <div className="home-hero-stage relative mx-auto w-full max-w-[1440px] overflow-hidden lg:overflow-visible">
        ...
        <p
          aria-hidden
          className="absolute left-[29px] top-[169px] whitespace-pre-line font-hero text-[25px] uppercase leading-[27px] text-black lg:left-[38px] lg:top-[182px] lg:w-[609px] lg:text-right lg:text-[50px] lg:leading-[50px] lg:tracking-[-2.5725px]"
        >
          {t("hero.titleLeft")}
        </p>
        ...
        <p
          aria-hidden
          className="absolute right-6 top-[620px] whitespace-pre-line text-right font-hero text-[25px] uppercase leading-[27px] text-black lg:left-[785px] lg:right-auto lg:top-[332px] lg:w-[588px] lg:text-left lg:text-[50px] lg:leading-[50px] lg:tracking-[-2.5725px]"
        >
          {t("hero.titleRight")}
        </p>
...
function HeroActions({
  ...
  return (
    <div className="absolute left-1/2 top-[703px] flex w-[min(352px,calc(100%-50px))] -translate-x-1/2 flex-col gap-[7px] lg:left-[109px] lg:top-[532px] lg:w-auto lg:translate-x-0 lg:items-start lg:gap-4">
      <ButtonLink
        href="/contact"
        withArrow
...
function HeroStats({ stats }: { stats: HeroStat[] }) {
  return (
    <dl className="absolute left-[29px] top-[373px] flex flex-col gap-[5px] lg:left-1/2 lg:top-[755px] lg:-translate-x-1/2 lg:flex-row lg:items-center lg:gap-[49px]">
